  ...
  <div class="info-main-wrapper hide-it" id="infoMainWrapper">
    <div class="info-column">
      <ul class="info-list">
        ...
        <li>Del:
          <a [attr.href]="'http://www.facebook.com/sharer.php?u=https://www.papercutodyssey.dk/themes/' + theme.id + '/works/' + current_work.id" target="_blank" class="share-buttons facebook">FB</a>
        </li>
      </ul><!-- .info-list -->
    </div><!-- .info-column -->
